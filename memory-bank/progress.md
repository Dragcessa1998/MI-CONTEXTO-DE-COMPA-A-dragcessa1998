...
- **Auditoría Hito 2 (agosto 2026)** ✅ — rama requerida `feature/domain-models`; se añadieron filtro combinado, orden multi-campo, suma/mínimo/máximo de salarios y una suite automatizada para colecciones, búsquedas, scoring, agregaciones y validaciones. Los scripts `npm run typecheck`, `npm test` y `npm run demo` documentan la validación reproducible.
