...
- **Auditoría Hito 3 (agosto 2026)** ✅ — rama `feature/talent-pipeline-tracker`; actualización a Next.js 16/React 19, scripts de lint/typecheck/test/build y pruebas unitarias para servicios HTTP y filtros combinados. Se mantienen CRUD, notas, query params, estados asíncronos y terminología Nexova.
