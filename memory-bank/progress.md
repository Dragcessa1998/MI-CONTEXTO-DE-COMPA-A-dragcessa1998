...
- **Evaluating a Regression Model (17/08/2026)** ✅ — evaluación formal del forecast con cinco folds `TimeSeriesSplit` expansivos, prueba explícita de orden cronológico, MAE/RMSE de entrenamiento y validación, media ± desviación estándar, curva de aprendizaje y diagnóstico reproducible. El informe conserva 2024–2025 fuera de la selección y propone una corrección específica coherente con el patrón observado.
